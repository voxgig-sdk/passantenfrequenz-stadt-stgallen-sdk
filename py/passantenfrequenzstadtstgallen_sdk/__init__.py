...
from passantenfrequenzstadtstgallen_sdk.utility import register

# Load features
from passantenfrequenzstadtstgallen_sdk.feature.base_feature import PassantenfrequenzStadtStgallenBaseFeature
from passantenfrequenzstadtstgallen_sdk.features import _has_feature, _make_feature
...
class PassantenfrequenzStadtStgallenSDK:
    ...
    def get_utility(self):
        return PassantenfrequenzStadtStgallenUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("PassantenfrequenzStadtStgallenSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Search(self, data=None) -> "SearchEntity":
        ...
        from passantenfrequenzstadtstgallen_sdk.entity.search_entity import SearchEntity
        return SearchEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "PassantenfrequenzStadtStgallenSDK":
        if sdkopts is None:
            sdkopts = {}
