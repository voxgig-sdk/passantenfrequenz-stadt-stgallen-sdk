...
func searchBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("PASSANTENFREQUENZ_STADT_STGALLEN_TEST_SEARCH_ENTID")
	...
	idmapResolved := core.ToMapAny(env["PASSANTENFREQUENZ_STADT_STGALLEN_TEST_SEARCH_ENTID"])
