...
AQL-driven CLI and REPL for the PassantenfrequenzStadtStgallen SDK. Positional arguments are
...
```sh
go build -o passantenfrequenz-stadt-stgallen-cli ./...
```
...
./passantenfrequenz-stadt-stgallen-cli load 1 search
./passantenfrequenz-stadt-stgallen-cli load '{id:1}' search
