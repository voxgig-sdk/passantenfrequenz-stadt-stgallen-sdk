...
// PassantenfrequenzStadtStgallen SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class PassantenfrequenzStadtStgallenTestFeature extends PassantenfrequenzStadtStgallenBaseFeature
{
    ...
    public function init(PassantenfrequenzStadtStgallenContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (PassantenfrequenzStadtStgallenContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = PassantenfrequenzStadtStgallenParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (PassantenfrequenzStadtStgallenContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(PassantenfrequenzStadtStgallenContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = PassantenfrequenzStadtStgallenParam::call($ctx, $k);
