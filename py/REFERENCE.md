# PassantenfrequenzStadtStgallen Python SDK Reference

Complete API reference for the PassantenfrequenzStadtStgallen Python SDK.
...
#### `PassantenfrequenzStadtStgallenSDK.test(testopts=None, sdkopts=None)`
