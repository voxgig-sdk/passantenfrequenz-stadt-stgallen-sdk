...
// PassantenfrequenzStadtStgallen SDK cache feature
...
class PassantenfrequenzStadtStgallenCacheFeature extends PassantenfrequenzStadtStgallenBaseFeature
{
    ...
    private function _through(PassantenfrequenzStadtStgallenContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
