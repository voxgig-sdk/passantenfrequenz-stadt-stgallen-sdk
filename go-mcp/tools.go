...
func registerTools(server *mcp.Server, client *sdk.PassantenfrequenzStadtStgallenSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "passantenfrequenz-stadt-stgallen_list",
		Description: "List records from PassantenfrequenzStadtStgallen. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "passantenfrequenz-stadt-stgallen_load",
		Description: "Load a single record from PassantenfrequenzStadtStgallen. " +
...
func runOp(client *sdk.PassantenfrequenzStadtStgallenSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.PassantenfrequenzStadtStgallenSDK, name string) (sdk.PassantenfrequenzStadtStgallenEntity, error) {
