# PassantenfrequenzStadtStgallen SDK — README + REFERENCE example snippet tests.
#
...
#      (PassantenfrequenzStadtStgallenSDK.test) seeded with an in-memory fixture for every
