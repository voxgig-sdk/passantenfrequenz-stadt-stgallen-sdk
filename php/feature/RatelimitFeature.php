...
// PassantenfrequenzStadtStgallen SDK ratelimit feature
...
class PassantenfrequenzStadtStgallenRatelimitFeature extends PassantenfrequenzStadtStgallenBaseFeature
{
    ...
    private function _acquire(PassantenfrequenzStadtStgallenContext $ctx): void
    {
    ...
    private function _track(PassantenfrequenzStadtStgallenContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
