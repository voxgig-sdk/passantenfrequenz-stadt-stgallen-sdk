...
// PassantenfrequenzStadtStgallen SDK utility type

class PassantenfrequenzStadtStgallenUtility
{
    ...
    public static function copy(PassantenfrequenzStadtStgallenUtility $src): PassantenfrequenzStadtStgallenUtility
    {
        $u = new PassantenfrequenzStadtStgallenUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
