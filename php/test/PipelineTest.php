...
// PassantenfrequenzStadtStgallen SDK pipeline test
//
...
{
    private static function utility(): PassantenfrequenzStadtStgallenUtility
    {
        return new PassantenfrequenzStadtStgallenUtility();
    }
    ...
    private static function ctx(array $over = []): PassantenfrequenzStadtStgallenContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new PassantenfrequenzStadtStgallenContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new PassantenfrequenzStadtStgallenOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof PassantenfrequenzStadtStgallenError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new PassantenfrequenzStadtStgallenOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = PassantenfrequenzStadtStgallenMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new PassantenfrequenzStadtStgallenOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = PassantenfrequenzStadtStgallenMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new PassantenfrequenzStadtStgallenOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = PassantenfrequenzStadtStgallenMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new PassantenfrequenzStadtStgallenSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = PassantenfrequenzStadtStgallenMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new PassantenfrequenzStadtStgallenResponse([]),
            'result' => new PassantenfrequenzStadtStgallenResult([]),
        ]);
        [, $err] = PassantenfrequenzStadtStgallenMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new PassantenfrequenzStadtStgallenSpec([]),
            'response' => null,
            'result' => new PassantenfrequenzStadtStgallenResult([]),
        ]);
        [, $err] = PassantenfrequenzStadtStgallenMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new PassantenfrequenzStadtStgallenSpec(['step' => 's']),
            'response' => new PassantenfrequenzStadtStgallenResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new PassantenfrequenzStadtStgallenResult([]),
        ]);
        [, $err] = PassantenfrequenzStadtStgallenMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new PassantenfrequenzStadtStgallenSpec(['step' => 's']),
            'response' => new PassantenfrequenzStadtStgallenResponse(self::resp(200, ['v' => 1])),
            'result' => new PassantenfrequenzStadtStgallenResult([]),
        ]);
        [, $err] = PassantenfrequenzStadtStgallenMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new PassantenfrequenzStadtStgallenSpec(['step' => 's']),
            'response' => new PassantenfrequenzStadtStgallenResponse(self::resp(200, ['v' => 2])),
            'result' => new PassantenfrequenzStadtStgallenResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        PassantenfrequenzStadtStgallenMakeResponse::call($ctx);
    ...
    {
        $preset = new PassantenfrequenzStadtStgallenResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new PassantenfrequenzStadtStgallenSpec([]),
            'response' => new PassantenfrequenzStadtStgallenResponse([]),
            'result' => new PassantenfrequenzStadtStgallenResult([]),
        ...
        [$got, $err] = PassantenfrequenzStadtStgallenMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new PassantenfrequenzStadtStgallenResult([])]);
        [, $err] = PassantenfrequenzStadtStgallenMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new PassantenfrequenzStadtStgallenSpec([]), 'result' => null]);
        [, $err] = PassantenfrequenzStadtStgallenMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new PassantenfrequenzStadtStgallenSpec(['step' => 's']),
            'result' => new PassantenfrequenzStadtStgallenResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new PassantenfrequenzStadtStgallenOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = PassantenfrequenzStadtStgallenMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new PassantenfrequenzStadtStgallenSpec(['step' => 's']),
            'result' => new PassantenfrequenzStadtStgallenResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new PassantenfrequenzStadtStgallenOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = PassantenfrequenzStadtStgallenMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new PassantenfrequenzStadtStgallenResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new PassantenfrequenzStadtStgallenSpec([]),
            'result' => new PassantenfrequenzStadtStgallenResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = PassantenfrequenzStadtStgallenMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = PassantenfrequenzStadtStgallenMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new PassantenfrequenzStadtStgallenError('boom', 'boom');
        $utility->fetcher = function (PassantenfrequenzStadtStgallenContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new PassantenfrequenzStadtStgallenSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = PassantenfrequenzStadtStgallenMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (PassantenfrequenzStadtStgallenContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = PassantenfrequenzStadtStgallenMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(PassantenfrequenzStadtStgallenResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        PassantenfrequenzStadtStgallenMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (PassantenfrequenzStadtStgallenContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new PassantenfrequenzStadtStgallenSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = PassantenfrequenzStadtStgallenMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new PassantenfrequenzStadtStgallenResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new PassantenfrequenzStadtStgallenSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = PassantenfrequenzStadtStgallenMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = PassantenfrequenzStadtStgallenMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = PassantenfrequenzStadtStgallenMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new PassantenfrequenzStadtStgallenResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, PassantenfrequenzStadtStgallenDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new PassantenfrequenzStadtStgallenResult(['ok' => false])]);
        $this->expectException(PassantenfrequenzStadtStgallenError::class);
        PassantenfrequenzStadtStgallenDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new PassantenfrequenzStadtStgallenResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', PassantenfrequenzStadtStgallenMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        PassantenfrequenzStadtStgallenMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new PassantenfrequenzStadtStgallenBaseFeature();
        $b = new PassantenfrequenzStadtStgallenBaseFeature();
        PassantenfrequenzStadtStgallenFeatureAdd::call($ctx, $a);
        PassantenfrequenzStadtStgallenFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): PassantenfrequenzStadtStgallenBaseFeature
    {
        $f = new PassantenfrequenzStadtStgallenBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        PassantenfrequenzStadtStgallenFeatureAdd::call($ctx, self::named_feature('a'));
        PassantenfrequenzStadtStgallenFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        PassantenfrequenzStadtStgallenFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        PassantenfrequenzStadtStgallenFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        PassantenfrequenzStadtStgallenFeatureAdd::call($ctx, $replace);
        ...
        PassantenfrequenzStadtStgallenFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): PassantenfrequenzStadtStgallenContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new PassantenfrequenzStadtStgallenSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = PassantenfrequenzStadtStgallenPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        PassantenfrequenzStadtStgallenPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new PassantenfrequenzStadtStgallenResponse(['headers' => null]),
            'result' => new PassantenfrequenzStadtStgallenResult([]),
        ]);
        PassantenfrequenzStadtStgallenResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        PassantenfrequenzStadtStgallenResultBody::call($ctx);
