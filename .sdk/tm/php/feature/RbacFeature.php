...
// PassantenfrequenzStadtStgallen SDK rbac feature
...
class PassantenfrequenzStadtStgallenRbacFeature extends PassantenfrequenzStadtStgallenBaseFeature
{
    ...
    private function _required(PassantenfrequenzStadtStgallenContext $ctx): ?string
    {
    ...
    private function _reject(PassantenfrequenzStadtStgallenContext $ctx, string $required): void
    {
    ...
    private function _track(PassantenfrequenzStadtStgallenContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
