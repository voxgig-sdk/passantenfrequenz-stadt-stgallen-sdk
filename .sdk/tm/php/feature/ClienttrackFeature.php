...
// PassantenfrequenzStadtStgallen SDK clienttrack feature
...
class PassantenfrequenzStadtStgallenClienttrackFeature extends PassantenfrequenzStadtStgallenBaseFeature
{
    ...
    public function PostConstruct(PassantenfrequenzStadtStgallenContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'PassantenfrequenzStadtStgallen-SDK';
