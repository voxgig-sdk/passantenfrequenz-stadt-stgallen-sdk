...
function envOverride(m) {
    if ('TRUE' === process.env.PASSANTENFREQUENZ_STADT_STGALLEN_TEST_LIVE ||
        'TRUE' === process.env.PASSANTENFREQUENZ_STADT_STGALLEN_TEST_OVERRIDE) {
    ...
    m.PASSANTENFREQUENZ_STADT_STGALLEN_TEST_EXPLAIN = process.env.PASSANTENFREQUENZ_STADT_STGALLEN_TEST_EXPLAIN || m.PASSANTENFREQUENZ_STADT_STGALLEN_TEST_EXPLAIN;
    return m;
}
