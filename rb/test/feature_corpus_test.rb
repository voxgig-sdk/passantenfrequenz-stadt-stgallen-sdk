# PassantenfrequenzStadtStgallen SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # PassantenfrequenzStadtStgallenSDK.new, not PassantenfrequenzStadtStgallenSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    PassantenfrequenzStadtStgallenSDK.new(opts)
  end
