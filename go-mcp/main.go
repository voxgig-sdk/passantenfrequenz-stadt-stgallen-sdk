// Command PassantenfrequenzStadtStgallen-mcp is an MCP server exposing the PassantenfrequenzStadtStgallen
// SDK as MCP tools.
//
// Two tools are registered:
//
//	PassantenfrequenzStadtStgallen_list  — list records of an entity
//	PassantenfrequenzStadtStgallen_load  — load a single record of an entity
//
