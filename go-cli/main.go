// Command PassantenfrequenzStadtStgallen-cli is a CLI + REPL for the PassantenfrequenzStadtStgallen SDK,
...
const prompt = "passantenfrequenz-stadt-stgallen"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      PASSANTENFREQUENZ_STADT_STGALLEN_APIKEY (api key), PASSANTENFREQUENZ_STADT_STGALLEN_BASE (base url override)")
