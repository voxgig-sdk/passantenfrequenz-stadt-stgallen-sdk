...
// PassantenfrequenzStadtStgallen SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = PassantenfrequenzStadtStgallenOmni::makeStructRunner(
    ...
    {
        return PassantenfrequenzStadtStgallenOmni::objmodel(PassantenfrequenzStadtStgallenOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return PassantenfrequenzStadtStgallenOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return PassantenfrequenzStadtStgallenOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(PassantenfrequenzStadtStgallenOmni::structfix($now, Struct::undef()))
                        !== json_encode(PassantenfrequenzStadtStgallenOmni::structfix($val, Struct::undef()))) {
