# PassantenfrequenzStadtStgallen SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions PassantenfrequenzStadtStgallenSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both PassantenfrequenzStadtStgallenSDK(...) and PassantenfrequenzStadtStgallenSDK.test(...) become
#      PassantenfrequenzStadtStgallenSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "passantenfrequenzstadtstgallen_sdk"
_SDK_CLASS = "PassantenfrequenzStadtStgallenSDK"
