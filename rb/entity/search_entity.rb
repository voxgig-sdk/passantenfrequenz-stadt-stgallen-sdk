# PassantenfrequenzStadtStgallen SDK Search entity
...
class SearchEntity
  ...
  def data_set(args)
    if args
      @_data = PassantenfrequenzStadtStgallenHelpers.to_map(VoxgigStruct.clone(args)) || {}
  ...
  def match_set(args)
    if args
      @_match = PassantenfrequenzStadtStgallenHelpers.to_map(VoxgigStruct.clone(args)) || {}
  ...
  # @return [Array<Search>, Array] the matching Search items; raises PassantenfrequenzStadtStgallenError on failure
