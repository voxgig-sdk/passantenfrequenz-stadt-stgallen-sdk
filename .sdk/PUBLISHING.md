...
|---|---|---|
| `ts/` | @voxgig-sdk/passantenfrequenz-stadt-stgallen-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/passantenfrequenz-stadt-stgallen-sdk \
      --repository voxgig-sdk/passantenfrequenz-stadt-stgallen-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/passantenfrequenz-stadt-stgallen-sdk` shows it, and
`npm trust revoke @voxgig-sdk/passantenfrequenz-stadt-stgallen-sdk --id=<id>` removes it.
