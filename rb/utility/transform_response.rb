# PassantenfrequenzStadtStgallen SDK utility: transform_response
...
module PassantenfrequenzStadtStgallenUtilities
  TransformResponse = ->(ctx) {
    ...
    transform = PassantenfrequenzStadtStgallenHelpers.to_map(VoxgigStruct.getprop(point, "transform"))
