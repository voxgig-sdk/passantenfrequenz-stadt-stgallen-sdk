...
// PassantenfrequenzStadtStgallen SDK utility: graphql
//
...
class PassantenfrequenzStadtStgallenGraphql
{
    ...
    // equivalent.
    public static function body(PassantenfrequenzStadtStgallenContext $ctx): mixed
    {
    ...
    public static function errors(PassantenfrequenzStadtStgallenContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
