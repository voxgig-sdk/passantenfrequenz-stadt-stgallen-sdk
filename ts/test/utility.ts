...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.PASSANTENFREQUENZSTADTSTGALLEN_TEST_LIVE ||
    'TRUE' === process.env.PASSANTENFREQUENZSTADTSTGALLEN_TEST_OVERRIDE
  ) {
  ...
  m.PASSANTENFREQUENZSTADTSTGALLEN_TEST_EXPLAIN = process.env.PASSANTENFREQUENZSTADTSTGALLEN_TEST_EXPLAIN || m.PASSANTENFREQUENZSTADTSTGALLEN_TEST_EXPLAIN
