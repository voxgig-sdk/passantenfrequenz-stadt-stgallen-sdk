...
// PassantenfrequenzStadtStgallen SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (PassantenfrequenzStadtStgallenSDK::test)
...
{
    private const SDK_CLASS = 'PassantenfrequenzStadtStgallenSDK';
    ...
    private const SDK_BASE = 'passantenfrequenzstadtstgallen_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../passantenfrequenzstadtstgallen_sdk.php';
