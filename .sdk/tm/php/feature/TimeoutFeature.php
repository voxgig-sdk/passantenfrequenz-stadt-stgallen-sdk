...
// PassantenfrequenzStadtStgallen SDK timeout feature
...
class PassantenfrequenzStadtStgallenTimeoutFeature extends PassantenfrequenzStadtStgallenBaseFeature
{
    ...
    private function _with_timeout(PassantenfrequenzStadtStgallenContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(PassantenfrequenzStadtStgallenContext $_ctx, float $ms): void
    {
        $client = $this->client;
