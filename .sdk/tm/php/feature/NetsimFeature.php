...
// PassantenfrequenzStadtStgallen SDK netsim feature
...
class PassantenfrequenzStadtStgallenNetsimFeature extends PassantenfrequenzStadtStgallenBaseFeature
{
    ...
    private function _simulate(PassantenfrequenzStadtStgallenContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(PassantenfrequenzStadtStgallenContext $ctx, array $applied): void
    {
        $client = $this->client;
