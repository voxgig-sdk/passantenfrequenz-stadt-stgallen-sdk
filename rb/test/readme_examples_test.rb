...
#      offline in seeded test mode (PassantenfrequenzStadtStgallenSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "PassantenfrequenzStadtStgallen_sdk.rb")
  SDK_CLASS = "PassantenfrequenzStadtStgallenSDK"
  ...
  SDK_BASE = "PassantenfrequenzStadtStgallen_sdk"
