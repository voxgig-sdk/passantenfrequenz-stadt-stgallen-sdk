...
func registerSDKWords(r *eng.Registry, client *sdk.PassantenfrequenzStadtStgallenSDK) {
...
func runOp(client *sdk.PassantenfrequenzStadtStgallenSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
