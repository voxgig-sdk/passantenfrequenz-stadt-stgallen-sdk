...
class PassantenfrequenzStadtStgallenTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = PassantenfrequenzStadtStgallenTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = PassantenfrequenzStadtStgallenTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = PassantenfrequenzStadtStgallenTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
