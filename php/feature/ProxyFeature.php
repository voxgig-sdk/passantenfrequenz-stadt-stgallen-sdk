...
// PassantenfrequenzStadtStgallen SDK proxy feature
...
class PassantenfrequenzStadtStgallenProxyFeature extends PassantenfrequenzStadtStgallenBaseFeature
{
    ...
    public function init(PassantenfrequenzStadtStgallenContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (PassantenfrequenzStadtStgallenContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
