...
// PassantenfrequenzStadtStgallen SDK utility: fetcher

class PassantenfrequenzStadtStgallenFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; PassantenfrequenzStadtStgallenSDK/1.0)';
    ...
    public static function call(PassantenfrequenzStadtStgallenContext $ctx, string $fullurl, array $fetchdef): array
    {
