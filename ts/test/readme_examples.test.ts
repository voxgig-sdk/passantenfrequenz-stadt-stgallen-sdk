...
//     (\`new PassantenfrequenzStadtStgallenSDK(...)\` / \`PassantenfrequenzStadtStgallenSDK.test(...)\` become
//     \`PassantenfrequenzStadtStgallenSDK.test({ entity: ... })\`), transpiled to JS, and run
...
const SDK_NAME = 'PassantenfrequenzStadtStgallenSDK'
...
// rewrite real client construction (\`new PassantenfrequenzStadtStgallenSDK(...)\` and any
// \`PassantenfrequenzStadtStgallenSDK.test(...)\`) to a seeded test-mode client, and give
...
function rewriteForRun(code: string): string {
  ...
  out = out.replace(/new\s+PassantenfrequenzStadtStgallenSDK\s*\([^)]*\)/g, () => SEEDED_CTOR)
  out = out.replace(/PassantenfrequenzStadtStgallenSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR)
