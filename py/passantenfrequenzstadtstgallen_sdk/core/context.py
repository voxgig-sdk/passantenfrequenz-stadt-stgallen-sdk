...
from passantenfrequenzstadtstgallen_sdk.core.control import PassantenfrequenzStadtStgallenControl
...
from passantenfrequenzstadtstgallen_sdk.core.helpers import get_ctx_prop, to_map
...
class PassantenfrequenzStadtStgallenContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = PassantenfrequenzStadtStgallenControl()
        ...
        if isinstance(sp, PassantenfrequenzStadtStgallenSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, PassantenfrequenzStadtStgallenResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, PassantenfrequenzStadtStgallenResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return PassantenfrequenzStadtStgallenOperation({})
        ...
        op = PassantenfrequenzStadtStgallenOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return PassantenfrequenzStadtStgallenError(code, msg, self)
