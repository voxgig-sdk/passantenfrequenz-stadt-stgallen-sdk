...
const PassantenfrequenzStadtStgallenError_1 = require("./PassantenfrequenzStadtStgallenError");
...
class Context {
    ...
    error(code, msg) {
        return new PassantenfrequenzStadtStgallenError_1.PassantenfrequenzStadtStgallenError(code, msg, this);
    }
    toJSON() {
        return {
            id: this.id,
