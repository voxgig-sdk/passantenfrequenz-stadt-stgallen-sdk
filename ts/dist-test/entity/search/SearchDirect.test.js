...
(0, node_test_1.describe)('SearchDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.PassantenfrequenzStadtStgallenSDK({
    ...
    (0, node_test_1.test)('direct-list-search', async (t) => {
        ...
        const query = {};
        if (setup.live) {
            query.dataset = "fussganger-stgaller-innenstadt-vadianstrasse";
        }
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.PassantenfrequenzStadtStgallenSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['PASSANTENFREQUENZ_STADT_STGALLEN_TEST_SEARCH_ENTID'];
    ...
    const client = new __1.PassantenfrequenzStadtStgallenSDK({
        base: 'http://localhost:8080',
